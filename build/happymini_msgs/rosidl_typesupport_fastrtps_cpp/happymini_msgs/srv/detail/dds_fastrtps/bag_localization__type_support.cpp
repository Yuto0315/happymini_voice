...
#include "happymini_msgs/srv/detail/bag_localization__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const happymini_msgs::srv::BagLocalization_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<happymini_msgs::srv::BagLocalization_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BagLocalization_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const happymini_msgs::srv::BagLocalization_Request *>(
...
static size_t _BagLocalization_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BagLocalization_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BagLocalization_Request__callbacks = {
  "happymini_msgs::srv",
...
static rosidl_message_type_support_t _BagLocalization_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BagLocalization_Request__callbacks,
...
{
  return &happymini_msgs::srv::typesupport_fastrtps_cpp::_BagLocalization_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const happymini_msgs::srv::BagLocalization_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<happymini_msgs::srv::BagLocalization_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BagLocalization_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const happymini_msgs::srv::BagLocalization_Response *>(
...
static size_t _BagLocalization_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BagLocalization_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BagLocalization_Response__callbacks = {
  "happymini_msgs::srv",
...
static rosidl_message_type_support_t _BagLocalization_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BagLocalization_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &happymini_msgs::srv::typesupport_fastrtps_cpp::_BagLocalization_Response__handle;
}
...
static service_type_support_callbacks_t _BagLocalization__callbacks = {
  "happymini_msgs::srv",
  "BagLocalization",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, happymini_msgs, srv, BagLocalization_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, happymini_msgs, srv, BagLocalization_Response)(),
...
static rosidl_service_type_support_t _BagLocalization__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BagLocalization__callbacks,
...
{
  return &happymini_msgs::srv::typesupport_fastrtps_cpp::_BagLocalization__handle;
}
