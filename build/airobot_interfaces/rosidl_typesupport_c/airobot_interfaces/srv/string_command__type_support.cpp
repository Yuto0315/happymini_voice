...
static const _StringCommand_Request_type_support_symbol_names_t _StringCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, airobot_interfaces, srv, StringCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, airobot_interfaces, srv, StringCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, airobot_interfaces, srv, StringCommand_Request)() {
  return &::airobot_interfaces::srv::rosidl_typesupport_c::StringCommand_Request_message_type_support_handle;
}
...
static const _StringCommand_Response_type_support_symbol_names_t _StringCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, airobot_interfaces, srv, StringCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, airobot_interfaces, srv, StringCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, airobot_interfaces, srv, StringCommand_Response)() {
  return &::airobot_interfaces::srv::rosidl_typesupport_c::StringCommand_Response_message_type_support_handle;
}
...
static const _StringCommand_type_support_symbol_names_t _StringCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, airobot_interfaces, srv, StringCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, airobot_interfaces, srv, StringCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, airobot_interfaces, srv, StringCommand)() {
  return &::airobot_interfaces::srv::rosidl_typesupport_c::StringCommand_service_type_support_handle;
}
