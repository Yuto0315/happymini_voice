...
#include "airobot_interfaces/srv/detail/string_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const airobot_interfaces::srv::StringCommand_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<airobot_interfaces::srv::StringCommand_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StringCommand_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const airobot_interfaces::srv::StringCommand_Request *>(
...
static size_t _StringCommand_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StringCommand_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StringCommand_Request__callbacks = {
  "airobot_interfaces::srv",
...
static rosidl_message_type_support_t _StringCommand_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StringCommand_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_airobot_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<airobot_interfaces::srv::StringCommand_Request>()
{
  return &airobot_interfaces::srv::typesupport_fastrtps_cpp::_StringCommand_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const airobot_interfaces::srv::StringCommand_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<airobot_interfaces::srv::StringCommand_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StringCommand_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const airobot_interfaces::srv::StringCommand_Response *>(
...
static size_t _StringCommand_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StringCommand_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StringCommand_Response__callbacks = {
  "airobot_interfaces::srv",
...
static rosidl_message_type_support_t _StringCommand_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StringCommand_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &airobot_interfaces::srv::typesupport_fastrtps_cpp::_StringCommand_Response__handle;
}
...
static service_type_support_callbacks_t _StringCommand__callbacks = {
  "airobot_interfaces::srv",
  "StringCommand",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, airobot_interfaces, srv, StringCommand_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, airobot_interfaces, srv, StringCommand_Response)(),
...
static rosidl_service_type_support_t _StringCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StringCommand__callbacks,
...
{
  return &airobot_interfaces::srv::typesupport_fastrtps_cpp::_StringCommand__handle;
}
