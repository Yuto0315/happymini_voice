...
#include "airobot_interfaces/srv/detail/string_command__rosidl_typesupport_fastrtps_c.h"
...
#include "airobot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _StringCommand_Request__ros_msg_type = airobot_interfaces__srv__StringCommand_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_airobot_interfaces
size_t get_serialized_size_airobot_interfaces__srv__StringCommand_Request(
  const void * untyped_ros_message,
...
static uint32_t _StringCommand_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_airobot_interfaces__srv__StringCommand_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_airobot_interfaces
size_t max_serialized_size_airobot_interfaces__srv__StringCommand_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _StringCommand_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_airobot_interfaces__srv__StringCommand_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, airobot_interfaces, srv, StringCommand_Request)() {
...
using _StringCommand_Response__ros_msg_type = airobot_interfaces__srv__StringCommand_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_airobot_interfaces
size_t get_serialized_size_airobot_interfaces__srv__StringCommand_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StringCommand_Response__ros_msg_type * ros_message = static_cast<const _StringCommand_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_airobot_interfaces__srv__StringCommand_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_airobot_interfaces
size_t max_serialized_size_airobot_interfaces__srv__StringCommand_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _StringCommand_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_airobot_interfaces__srv__StringCommand_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, airobot_interfaces, srv, StringCommand_Response)() {
...
// already included above
// #include "airobot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "airobot_interfaces/srv/string_command.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, airobot_interfaces, srv, StringCommand)() {
