...
happymini_msgs__srv__BagLocalization_Request__init(happymini_msgs__srv__BagLocalization_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->left_right)) {
    happymini_msgs__srv__BagLocalization_Request__fini(msg);
    return false;
  }
  // degree
  // graph
...
happymini_msgs__srv__BagLocalization_Request__create()
{
  ...
  happymini_msgs__srv__BagLocalization_Request * msg = (happymini_msgs__srv__BagLocalization_Request *)allocator.allocate(sizeof(happymini_msgs__srv__BagLocalization_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(happymini_msgs__srv__BagLocalization_Request));
  bool success = happymini_msgs__srv__BagLocalization_Request__init(msg);
  if (!success) {
...
happymini_msgs__srv__BagLocalization_Request__Sequence__init(happymini_msgs__srv__BagLocalization_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymini_msgs__srv__BagLocalization_Request * data = NULL;

  if (size) {
    data = (happymini_msgs__srv__BagLocalization_Request *)allocator.zero_allocate(size, sizeof(happymini_msgs__srv__BagLocalization_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = happymini_msgs__srv__BagLocalization_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        happymini_msgs__srv__BagLocalization_Request__fini(&data[i - 1]);
      }
...
happymini_msgs__srv__BagLocalization_Request__Sequence__fini(happymini_msgs__srv__BagLocalization_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      happymini_msgs__srv__BagLocalization_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymini_msgs__srv__BagLocalization_Request__Sequence * array = (happymini_msgs__srv__BagLocalization_Request__Sequence *)allocator.allocate(sizeof(happymini_msgs__srv__BagLocalization_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = happymini_msgs__srv__BagLocalization_Request__Sequence__init(array, size);
  if (!success) {
...
happymini_msgs__srv__BagLocalization_Request__Sequence__destroy(happymini_msgs__srv__BagLocalization_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    happymini_msgs__srv__BagLocalization_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
happymini_msgs__srv__BagLocalization_Request__Sequence__are_equal(const happymini_msgs__srv__BagLocalization_Request__Sequence * lhs, const happymini_msgs__srv__BagLocalization_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!happymini_msgs__srv__BagLocalization_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  happymini_msgs__srv__BagLocalization_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(happymini_msgs__srv__BagLocalization_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    happymini_msgs__srv__BagLocalization_Request * data =
      (happymini_msgs__srv__BagLocalization_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!happymini_msgs__srv__BagLocalization_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          happymini_msgs__srv__BagLocalization_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!happymini_msgs__srv__BagLocalization_Request__copy(
...
happymini_msgs__srv__BagLocalization_Response__are_equal(const happymini_msgs__srv__BagLocalization_Response * lhs, const happymini_msgs__srv__BagLocalization_Response * rhs)
{
  ...
  // angle_to_bag
  if (lhs->angle_to_bag != rhs->angle_to_bag) {
    return false;
  }
  // distance_to_bag
  if (lhs->distance_to_bag != rhs->distance_to_bag) {
    return false;
  }
  return true;
}
  ...
  happymini_msgs__srv__BagLocalization_Response * output)
{
  ...
  // angle_to_bag
  output->angle_to_bag = input->angle_to_bag;
  // distance_to_bag
  output->distance_to_bag = input->distance_to_bag;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymini_msgs__srv__BagLocalization_Response * msg = (happymini_msgs__srv__BagLocalization_Response *)allocator.allocate(sizeof(happymini_msgs__srv__BagLocalization_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(happymini_msgs__srv__BagLocalization_Response));
  bool success = happymini_msgs__srv__BagLocalization_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
happymini_msgs__srv__BagLocalization_Response__destroy(happymini_msgs__srv__BagLocalization_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    happymini_msgs__srv__BagLocalization_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
happymini_msgs__srv__BagLocalization_Response__Sequence__init(happymini_msgs__srv__BagLocalization_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymini_msgs__srv__BagLocalization_Response * data = NULL;

  if (size) {
    data = (happymini_msgs__srv__BagLocalization_Response *)allocator.zero_allocate(size, sizeof(happymini_msgs__srv__BagLocalization_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = happymini_msgs__srv__BagLocalization_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        happymini_msgs__srv__BagLocalization_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
happymini_msgs__srv__BagLocalization_Response__Sequence__fini(happymini_msgs__srv__BagLocalization_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      happymini_msgs__srv__BagLocalization_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymini_msgs__srv__BagLocalization_Response__Sequence * array = (happymini_msgs__srv__BagLocalization_Response__Sequence *)allocator.allocate(sizeof(happymini_msgs__srv__BagLocalization_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = happymini_msgs__srv__BagLocalization_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
happymini_msgs__srv__BagLocalization_Response__Sequence__destroy(happymini_msgs__srv__BagLocalization_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    happymini_msgs__srv__BagLocalization_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
happymini_msgs__srv__BagLocalization_Response__Sequence__are_equal(const happymini_msgs__srv__BagLocalization_Response__Sequence * lhs, const happymini_msgs__srv__BagLocalization_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!happymini_msgs__srv__BagLocalization_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  happymini_msgs__srv__BagLocalization_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(happymini_msgs__srv__BagLocalization_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    happymini_msgs__srv__BagLocalization_Response * data =
      (happymini_msgs__srv__BagLocalization_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!happymini_msgs__srv__BagLocalization_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          happymini_msgs__srv__BagLocalization_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!happymini_msgs__srv__BagLocalization_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
