...
#ifndef HAPPYMINI_MSGS__SRV__DETAIL__GRASP_BAG__FUNCTIONS_H_
#define HAPPYMINI_MSGS__SRV__DETAIL__GRASP_BAG__FUNCTIONS_H_
...
/// Initialize srv/GraspBag message.
/**
...
/// Create srv/GraspBag message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * happymini_msgs__srv__GraspBag_Request__init().
...
/// Destroy srv/GraspBag message.
/**
 * It calls
 * happymini_msgs__srv__GraspBag_Request__fini()
...
/// Check for srv/GraspBag message equality.
/**
...
/// Initialize array of srv/GraspBag messages.
/**
...
/// Finalize array of srv/GraspBag messages.
/**
 * It calls
 * happymini_msgs__srv__GraspBag_Request__fini()
...
/// Create array of srv/GraspBag messages.
/**
 * It allocates the memory for the array and calls
 * happymini_msgs__srv__GraspBag_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GraspBag messages.
/**
 * It calls
 * happymini_msgs__srv__GraspBag_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GraspBag message array equality.
/**
...
/// Copy an array of srv/GraspBag messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * happymini_msgs__srv__GraspBag_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_happymini_msgs
...
/**
 * It calls
 * happymini_msgs__srv__GraspBag_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_happymini_msgs
...
/**
 * It allocates the memory for the array and calls
 * happymini_msgs__srv__GraspBag_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_happymini_msgs
...
/**
 * It calls
 * happymini_msgs__srv__GraspBag_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HAPPYMINI_MSGS__SRV__DETAIL__GRASP_BAG__FUNCTIONS_H_
