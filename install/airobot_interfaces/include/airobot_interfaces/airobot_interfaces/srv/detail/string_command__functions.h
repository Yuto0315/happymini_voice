...
#ifndef AIROBOT_INTERFACES__SRV__DETAIL__STRING_COMMAND__FUNCTIONS_H_
#define AIROBOT_INTERFACES__SRV__DETAIL__STRING_COMMAND__FUNCTIONS_H_
...
#include "airobot_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_airobot_interfaces
bool
 ...
 * calls
 * airobot_interfaces__srv__StringCommand_Request__init().
...
/**
 * It calls
 * airobot_interfaces__srv__StringCommand_Request__fini()
 ...
 * airobot_interfaces__srv__StringCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * airobot_interfaces__srv__StringCommand_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * airobot_interfaces__srv__StringCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_airobot_interfaces
...
/**
 * It calls
 * airobot_interfaces__srv__StringCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_airobot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * airobot_interfaces__srv__StringCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_airobot_interfaces
...
/**
 * It calls
 * airobot_interfaces__srv__StringCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AIROBOT_INTERFACES__SRV__DETAIL__STRING_COMMAND__FUNCTIONS_H_
